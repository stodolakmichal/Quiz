...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void insertCategory(Category category){
        ...
        insertQuestion(q4);
        Question q5 = new Question("Non existing, Easy: B is correct",
                "A", "B", "C", 2, Question.DIFFICULTY_EASY, 4);
        insertQuestion(q5);
        Question q6 = new Question("Non existing, Medium: C is correct",
                "A", "B", "C", 3, Question.DIFFICULTY_MEDIUM, 5);
        insertQuestion(q6);
